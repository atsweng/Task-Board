...
namespace TaskBoard
{
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
        ...
        private void revisionlist_DragDrop(object sender, DragEventArgs e)
        {
            ...
            while (query.Read())
            {
                ...
                if (query.GetValue(7) != null)
                {
                    ...
                    cmdd.Parameters.AddWithValue("@işaciklaması", isaciklaması.ToString());
                    cmdd.Parameters.AddWithValue("@notlar", notlar.ToString());
                    cmdd.Parameters.AddWithValue("@tarih",Convert.ToDateTime( tarih));
                    cmdd.Parameters.AddWithValue("@kartno", kartno);
                    cmdd.Parameters.AddWithValue("@tahminisüre", tahminisüre.ToString());
                    cmdd.Parameters.AddWithValue("@gerceklesensüre", gerceklesensüre.ToString());
                    cmdd.Parameters.AddWithValue("@Id", index2);
            ...
            SqlCommand cmddd = new SqlCommand("delete from taskinfo where Id=@Id", con);

            cmddd.Parameters.AddWithValue("@Id", index);

            int j = cmddd.ExecuteNonQuery();
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand sc;
            SqlDataReader rd;
            string sql = "Select projeno from taskinfo where Id IS NOT NULL";
            ...
            SqlCommand sc2;
            SqlDataReader rd2;
            string sql2 = "Select projeno from taskinfo2 where Id IS NOT NULL";
            ...
            SqlCommand sc3;
            SqlDataReader rd3;
            string sql3 = "Select projeno from taskinfo3 where Id IS NOT NULL";
            ...
            try
            {
                ...
                while (rd3.Read())
                {
                    ...
                    revisionlist.Items.Add(rd3.GetValue(0).ToString());
            ...
            SqlCommand sc4;
            SqlDataReader rd4;
            string sql4 = "Select projeno from taskinfo4 where Id IS NOT NULL";
            ...
            try
            {
                ...
                while (rd4.Read())
                {
                    ...
                    checklist.Items.Add(rd4.GetValue(0).ToString());
            ...
            SqlCommand sc5;
            SqlDataReader rd5;
            string sql5 = "Select projeno from taskinfo5 where Id IS NOT NULL";
            ...
            try
            {
                ...
                while (rd5.Read())
                {
                    ...
                    donelist.Items.Add(rd5.GetValue(0).ToString());
